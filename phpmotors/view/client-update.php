    ...
    <div>
        ...
        <main>
            ...
            <form action="../accounts/index.php" method="post">
                ...
                <label>First Name <br><input type="text" name="clientFirstname" required <?php if(isset($clientFirstname)){echo "value='" . $clientFirstname . "'";}else{echo "value='" . $_SESSION["clientData"]["clientFirstname"] . "'";} ?>></label><br>
                <label>Last Name <br><input type="text" name="clientLastname" required <?php if(isset($clientLastname)){echo "value='" . $clientLastname . "'";}else{echo "value='" . $_SESSION["clientData"]["clientLastname"] . "'";} ?>></label><br>
                <label>Email <br><input type="email" name="clientEmail" required <?php if(isset($clientEmail)){echo "value='" . $clientEmail . "'";}else{echo "value='" . $_SESSION["clientData"]["clientEmail"] . "'";} ?>></label><br>
            ...
            <form action="../accounts/index.php" method="post">
                ...
                <label>Password <br><input type="password" name="clientPassword" title="Entering A Password Will Change Your Current Password" required pattern="(?=^.{8,}$)(?=.*\d)(?=.*\W+)(?![.\n])(?=.*[A-Z])(?=.*[a-z]).*$"></label><br>
